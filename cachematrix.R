...
## that can can set the matrix, get the matrix, set the inverse, or get
## the inverse, while also caching the matrix and its inverse.
...
## otherwise it computes the inverse of the matrix itself, and then returns
## the inverse.
